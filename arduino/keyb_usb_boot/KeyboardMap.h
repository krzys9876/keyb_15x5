...
const KeyRaw keyMap[ROWS*COLS*LAYERS] {
  ...
  {KEY_RESERVED,KEY_RESERVED,FN_SWITCH},{KEY_RESERVED,KEY_RESERVED,FN_MOUSE},{KEY_LEFT_WINDOWS,KEY_RESERVED,FN_NORM},{KEY_LEFT_ALT,KEY_RESERVED,FN_NORM},{KEY_RESERVED,KEY_SPACE,FN_NORM},
  ...
  {KEY_LEFT_SHIFT,KEY_RESERVED,FN_NORM},{KEY_RESERVED,KEY_RESERVED,FN_MOUSE},{KEY_RESERVED,KEY_Z,FN_NORM},{KEY_RESERVED,KEY_X,FN_NORM},{KEY_RESERVED,KEY_C,FN_NORM},
    {KEY_RESERVED,KEY_V,FN_NORM},{KEY_RESERVED,KEY_B,FN_NORM},{KEY_RESERVED,KEY_N,FN_NORM},{KEY_RESERVED,KEY_M,FN_NORM},{KEY_RESERVED,KEY_COMMA,FN_NORM},
